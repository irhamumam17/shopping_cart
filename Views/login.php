...
<body>
  ...
  <main>
    <div class="container wow fadeIn">
      ...
      <!-- Heading -->
      <h2 class="my-5 h2 text-center">Login form</h2>
      ...
      <div class="row">
        ...
        <div class="col-md-8 mb-4 mx-auto">
          ...
          <div class="card">
            ...
            <!--Card content-->
            <form class="card-body" method="POST" action="../Controllers/users/user_login.php">
              <!--email-->
              ...
              <!--address-->
              <div class="md-form mb-5">
                <input type="password" name="pass" id="pass" class="form-control" placeholder="12345678" required>
