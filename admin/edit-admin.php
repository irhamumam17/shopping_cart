...
if(isset($_GET['id'])){
    $admin = new Admin();
    $a = $admin->index_id($_SESSION);
    if($a['error']==true){
        echo "<script>alert('".$a['message']."')</script>";
    }else{
        $ad = $a['data'];
    }
}else{
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-8 mx-auto">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="../../Controllers/admin/admin-edit.php" method="POST">
                                        <input type="hidden" name="id" value="<?php echo $_GET['id']?>;">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating">Nama</label>
                                                    <input name="nama" type="text" class="form-control" value="<?php $ad['nama']; ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="username" type="text" class="form-control" value="<?php $ad['username']; ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <button name="simpan" type="submit" class="btn btn-primary pull-right">Tambah Item</button>
