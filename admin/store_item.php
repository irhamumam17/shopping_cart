                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title ">Store Item</h4>
                                    <p class="card-category"> Daftar Store Item</p>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table" id="myTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <?php echo $x['nama_category'];?>
                                                    </td>
                                                    <td>
                                                    <?php echo $x['keterangan'];?>
                                                    </td>
                                                    <td>
                                                    <a href="?id=<?php echo $x['id'];?>" type="button" class="btn btn-success btn-sm">Edit</a>
                                                        <a onclick="return confirm('Apakah Anda ingin menghapus item ini?')" href="Controllers/item/delete-item.php?id=<?php echo $x['id'];?>" type="button" class="btn btn-danger btn-sm">Delete</a>
                                                    </td>
                                                </tr>
                                                    <?php } ?>
                                            </tbody>
